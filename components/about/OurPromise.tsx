  ...
  return (
    <section className="bg-white py-16 sm:py-24">
      <div className="container-px mx-auto max-w-4xl flex flex-col items-center text-center">
        {/* Section Heading */}
        <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1E1E1E] mb-10">
          Our Promise to You
        </h2>

        {/* Founder & Product Image Banner */}
        <div className="relative w-full aspect-[16/9] sm:aspect-[21/9] rounded-2xl overflow-hidden shadow-md border border-neutral-100 mb-10 group">
          <Image
        ...
        <div className="flex flex-col gap-6 max-w-3xl text-neutral-600 font-normal text-xs sm:text-sm md:text-base leading-relaxed">
          <p>
