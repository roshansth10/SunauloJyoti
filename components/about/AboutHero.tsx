  ...
  return (
    ...
    >
      <div className="relative container-px mx-auto max-w-3xl text-center flex flex-col items-center">
        ...
        <p className="font-display text-sm min-[380px]:text-base sm:text-lg lg:text-xl font-semibold text-[#3E270E] mb-4 sm:mb-6">
          Rooted in Tradition. Crafted for Every Kitchen.
        </p>
        <p className="max-w-2xl text-xs sm:text-sm md:text-base leading-relaxed text-[#4A351E] mb-6 sm:mb-8 font-medium">
        ...
        <Link
          href="/products"
          className="inline-flex min-h-[44px] items-center justify-center px-7 sm:px-8 py-2.5 sm:py-3 rounded-full bg-gradient-to-r from-[#EA8C1C] to-[#D97706] text-white text-sm sm:text-base font-semibold shadow-md hover:shadow-lg hover:from-[#D97706] hover:to-[#B45309] transition-all duration-300 transform hover:-translate-y-0.5"
        >
          Explore Products
        </Link>
      </div>
